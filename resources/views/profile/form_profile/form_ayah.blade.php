...
$cek_user = User::where('data_warga_id', $ayah->id);
?>
<div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{Route('data-warga.store_user')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="email" id="email" value="{{$ayah->email}}">
                        <input type="hidden" name="no_hp" id="no_hp" value="{{$ayah->no_hp}}">
                        <input type="hidden" name="name" id="name" value="{{$ayah->nama}}">
                        <input type="hidden" name="name" id="name" value="{{$ayah->nama}}">
                        <input type="hidden" name="data_warga_id" id="data_warga_id" value="{{$ayah->id}}">

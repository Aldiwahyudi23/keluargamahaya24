    ...
    <form action="{{ route('transactions.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tujuan" id="tujuan" placeholder="Masukan No HP atau Token Listrik" class="form-control @error('tujuan') is-invalid @enderror" value="{{ old('tujuan') }}">

            ...
            <div class="col-12 col-sm-6">
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{Route('file-laporan.store')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-group row">
                                <label for="judul">Judul Laporan</label>
                                <input type="text" id="judul" name="judul" value="{{ old('judul') }}" placeholder="Judul Laporan" class="form-control col-12 @error('judul') is-invalid @enderror">
                                @error('judul')
                            ...
                            <div class="form-group row">
                                ...
                                <input type="file" id="file" name="file" value="{{ old('file') }}" placeholder="Upload file" class="form-control col-12 @error('file') is-invalid @enderror">
                                @error('file')
                                <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </div>

  ...
  <form action="{{ route('data-warga.update',Crypt::encrypt($data_warga->id)) }}" method="post" enctype="multipart/form-data">
      @method('PATCH')
      {{csrf_field()}}
      <div class="row">
          <div class="col-12 col-sm-4">
              <div class="card card-primary card-outline card-outline-tabs">
                  <div class="card">
                      <div class="card-body">
                          <center>
                              <h5 class="text-bold card-header bg-light p-0"> EDIT DATA</h5>
                          </center>
                          <hr>
                          <div class="form-group row">
                              <label for="nama">Nama Lengkap</label>
                              <input type="text" id="nama" name="nama" value="{{ old('nama',$data_warga->nama) }}" placeholder="Nama Lengkap" class="form-control col-12 @error('nama') is-invalid @enderror">
                              @error('nama')
                          ...
                          <div class="form-group">
                              ...
                              <select id="jenis_kelamin" name="jenis_kelamin" class="select2bs4 form-control col-12 @error('jenis_kelamin') is-invalid @enderror">
                                  @if(old('jenis_kelamin',$data_warga->jenis_kelamin) == true)
                                  <option value="{{old('jenis_kelamin',$data_warga->jenis_kelamin)}}">{{old('jenis_kelamin',$data_warga->jenis_kelamin)}}</option>
                                  @endif
                          ...
                          <div class="form-group row">
                              ...
                              <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir',$data_warga->tempat_lahir) }}" placeholder="Masukan Tempat Anda Lahir" class="form-control col-12 @error('tempat_lahir') is-invalid @enderror">
                              @error('tempat_lahir')
                              <div class="invalid-feedback">
                                  <strong>{{ $message }}</strong>
                              </div>
                          ...
                          <div class="form-group row">
                              ...
                              <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir',$data_warga->tanggal_lahir) }}" placeholder="tanggal_lahir Sub Menu" class="form-control col-12 @error('tanggal_lahir') is-invalid @enderror">
                              @error('tanggal_lahir')
                              <div class="invalid-feedback">
                                  <strong>{{ $message }}</strong>
                              </div>
              ...
              <div class="card card-primary card-outline card-outline-tabs">
                  <div class="card-body">
                      ...
                      <div class="form-group row">
                          ...
                          <input type="number" id="no_hp" name="no_hp" value="{{ old('no_hp',$data_warga->no_hp) }}" placeholder="62 81xx xxxx xxxx" class="form-control col-12 @error('no_hp') is-invalid @enderror">
                          @error('no_hp')
                          <div class="invalid-feedback">
                              <strong>{{ $message }}</strong>
                          </div>
                      ...
                      <div class="form-group">
                          ...
                          <select id="agama" name="agama" class="select2bs4 form-control @error('agama') is-invalid @enderror">
                              @if(old('agama',$data_warga->agama) == true)
                              <option value="{{old('agama',$data_warga->agama)}}">{{old('agama',$data_warga->agama)}}</option>
                              @endif
                      ...
                      <div class="form-group">
                          ...
                          <select id="status_pernikahan" name="status_pernikahan" class="select2bs4 form-control @error('status_pernikahan') is-invalid @enderror">
                              @if(old('status_pernikahan',$data_warga->status_pernikahan) == true)
                              <option value="{{old('status_pernikahan',$data_warga->status_pernikahan)}}">{{old('status_pernikahan',$data_warga->status_pernikahan)}}</option>
                              @endif

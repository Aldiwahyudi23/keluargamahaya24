...
<div class="row">
    <div class="col-12 col-sm-6">
        <div class="card card-primary card-outline card-outline-tabs">
            <div class="card-body">
                <center>
                    <h5 class="text-bold card-header bg-light p-0"> TAMBAH DATA MENU</h5>
                </center>
                <hr>
                ...
                <form action="{{Route('menu.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" id="kategori" class="select2bs4 form-control col-12 @error('kategori') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Nama Menu" class="form-control col-12 @error('nama') is-invalid @enderror">
                        @error('nama')
                        <div class="invalid-feedback">
                            <strong>{{ $message }}</strong>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" id="icon" name="icon" value="{{old('icon')}}" placeholder="fas fe-call" class="form-control col-12 @error('icon') is-invalid @enderror">
                        @error('icon')
                        <div class="invalid-feedback">
                            <strong>{{$message}}</strong>
                        </div>

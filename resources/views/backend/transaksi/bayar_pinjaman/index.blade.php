                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="pengeluaran_id">Pinjaman</label>
                                    <select name="pengeluaran_id" id="pengeluaran_id" class="select2bs4 col-12 form-control @error('pengeluaran_id') is-invalid @enderror">
                                        <option value="">--Pilih Pinjaman--</option>
                                        @foreach($data_pinjaman->get() as $data)
                                        <option value="{{$data->id}}">{{$data->kode}}-{{$data->data_warga->nama}}</option>
                                        @endforeach
    ...
    <div class="col-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">DATA SEMUA BAYAR PINJAMAN</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$no}}</td>
                            <td>{{$data->pengeluaran->kode}}</td>
                            <td>{{$data->kode}}</td>
                            <td>{{$data->data_warga->nama}}</td>
                            <td>{{$data->jumlah}}</td>
                            <td>{{$data->tanggal}}</td>
                            <td>{{$data->jumlah_lebih}}</td>
                            ...
                            <td>
                                <form action="{{route('pinjaman.destroy',Crypt::encrypt($data->id))}}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <a href="{{route('pinjaman.show',Crypt::encrypt($data->id))}}" class=""><i class="nav-icon fas fa-book"></i></a>
                                    <a href="{{route('pinjaman.edit',Crypt::encrypt($data->id))}}" class=""><i class="nav-icon fas fa-pencil-alt"></i></a>

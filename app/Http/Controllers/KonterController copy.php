...
class KonterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.bisnis.master_data_bisnis.data_konter.index', compact(
            'data_konter',
            'categories',
            'data_warga'
        ));
    ...
    public function konter_home()
    {
        ...
        return view('frontend.home.konter.index', Compact(
            'konter_tagihan_pulsa',
    ...
    public function konfirmasi_transaksi(Request $request, $id)
    {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS => array(
                ...
                'message' => "
🥳🥳🥳Yeee Transaksi atos Berhasil, Mangga di cek
